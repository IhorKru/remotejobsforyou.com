...
class SubscriberOptInDetails
{
    ...
    /**
     * @var bool
     * @Assert\NotBlank (message ="You must agree to RemoteJobsForU.com Terms & Conditions")
    ...
    /**
     * @var bool
     * @Assert\NotBlank (message ="You must agree to recieve notifications from RemoteJobsForU.com")
    ...
    /**
     * @var bool
     * @Assert\NotBlank (message ="You must agree to recieve notifications from partners of RemoteJobsForU.com")
